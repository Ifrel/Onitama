...
class JeuTest {
    ...
    void scenarion1DebutPartie() {
        try {
            ...
            jeu.jouerCoup(new Coup(new Point(0, 2), new Point(1, 2), jeu.getCarteSelectionnee(), jeu.getCarteSelectionnee()));
            System.err.println(jeu.toString());

            jeu.setCarteSelectionnee(1);
            jeu.setPionSelectionne(new Point(4, 0));
            jeu.jouerCoup(new Coup(new Point(4, 0), new Point(3, 1), jeu.getCarteSelectionnee(), jeu.getCarteSelectionnee()));
            System.err.println(jeu.toString());
