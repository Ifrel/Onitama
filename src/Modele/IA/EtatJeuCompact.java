 ...
 */
public class EtatJeuCompact implements Comparable<EtatJeuCompact> {
    ...
    public EtatJeuCompact(int joueurCourantID, Carte carteEnPlus, List<Carte> cartesJoueur1, List<Carte> cartesJoueur2, List<Pion> pionsJoueur1, List<Pion> pionsJoueur2) {
    ...
    public EtatJeuCompact(byte [] etatJeu) {
    ...
    @Override
    public int compareTo(EtatJeuCompact ej) {
        return hashCode() - ej.hashCode();
    }

    public List<EtatJeuCompact> etatsSuccesseurs() {
        List<EtatJeuCompact> lec = new ArrayList<>();
